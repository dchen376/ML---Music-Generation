...
class Autoencoder:
    ...
    def summary(self):
        ...
        self.model.summary() #autoencoder summary.
    ...
    def train(self, x_train, batch_size, num_epochs):
        self.model.fit(x_train, #expected output (for autoencoder)
                       x_train, #the input
    ...
    def load(cls, save_folder="."):
        ...
        autoencoder = Autoencoder(*parameters) # *-> for unpacking iterable objects like lists.
    ...
    """
    Build autoencodere (encoder + decoder)
    """
